...
\begin{figure}[ht]
\centering
\includegraphics[width=.9\textwidth]{img/content/block1_conv1}
\caption*{Block 1 Conv 1}
\end{figure}
\end{frame}
...
\begin{figure}[ht]
\centering
\includegraphics[width=.9\textwidth]{img/content/block2_conv1}
\caption*{Block 2 Conv 1}
\end{figure}
\end{frame}
...
difference between $G^l$ and $A^l$. In this sense,
