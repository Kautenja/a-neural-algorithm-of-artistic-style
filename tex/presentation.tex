...
\begin{frame}{Approach in this paper}
    \begin{enumerate}
        ...
        \item Train a white noise image based on a
            loss function that captures both
            content of the image and style of
            the work of art.
    \end{enumerate}
\end{frame}
\begin{frame}{Approach in this paper}
    \framesubtitle{Loss function}
    Two types of loss functions are taken into account:
    \begin{enumerate}
        \item A loss function that aims at capturing
            the content of the image by reducing the
            distance between features, at each level.
            ($\mathcal{L}_{content}$)
        \item A loss fuction that aims at capturing
            the style of the work of art by reducing
    ...
    $ \mathcal{L} =
    \alpha \mathcal{L}_{content} \times
